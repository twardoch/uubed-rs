// this_file: crates/uubed-core/tests/version_test.rs
...
fn test_feature_flags() {
    ...
    #[cfg(feature = "simd")]
    {
        // SIMD feature is enabled; nothing to assert beyond successful compilation.
    }

    #[cfg(not(feature = "simd"))]
    {
        // SIMD feature is disabled; nothing to assert beyond successful compilation.
    }
}
