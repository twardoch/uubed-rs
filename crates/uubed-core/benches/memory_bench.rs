    ...
    for size in [128, 1024, 8192, 65536].iter() {
        ...
        group.bench_function(BenchmarkId::new("encode", size), |b| {
            b.iter_custom(|iters| {
                ...
                println!(
                    "Q64 encode size={}: peak memory = {} bytes",
                    size, peak_memory
                );
                total_time
            })
                ...
                group.bench_function(
                    ...
                    |b| {
                        b.iter_custom(|iters| {
                            ...
                            println!(
                                "Top-k original size={} k={}: peak memory = {} bytes",
                                size, k, peak_memory
                            );
                            total_time
                        })
                ...
                group.bench_function(
                    ...
                    |b| {
                        b.iter_custom(|iters| {
                            ...
                            println!(
                                "Top-k optimized size={} k={}: peak memory = {} bytes",
                                size, k, peak_memory
                            );
                            total_time
                        })
            ...
            group.bench_function(
                ...
                |b| {
                    b.iter_custom(|iters| {
                        ...
                        println!(
                            "SimHash size={} planes={}: peak memory = {} bytes",
...
fn bench_memory_concurrent(c: &mut Criterion) {
    ...
    for num_threads in [2, 4, 8, 16].iter() {
        group.bench_function(BenchmarkId::new("concurrent-load", num_threads), |b| {
            b.iter_custom(|iters| {
                let mut total_time = std::time::Duration::new(0, 0);
                let mut peak_memory = 0;
                ...
                println!(
                    "Concurrent {} threads: peak memory = {} bytes",
